...
\begin{itemize}
  \item 可扩展性和成本：可扩展性是指网络应能够根据数据处理要求的提高而可以比较容易地增加服务器的数量；
...
\begin{itemize}
    \item Scalability and Cost: Scalability means that the network should be able to increase the number of servers relatively easily according to the improvement of data processing requirements;
